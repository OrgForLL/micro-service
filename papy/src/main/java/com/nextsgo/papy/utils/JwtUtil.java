...
public class JwtUtil {
	 ...
	 * @return
	 */
	public static String createJWT(long ttlMillis, String key, User user) {
	 ...
	 * @return
	 */
	public static Claims parseJWT(String token, String key, User user) {
		// 签名秘钥，和生成的签名的秘钥一模一样
		// String key = jwtProperties.getKey() ;
	 ...
	 * @return
	 */
	public static Boolean isVerify(String token, String key, User user) {
		// 签名秘钥，和生成的签名的秘钥一模一样
		// String key = jwtProperties.getKey();
